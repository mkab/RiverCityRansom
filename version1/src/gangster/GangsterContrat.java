...
public class GangsterContrat extends GangsterDecorator {
  ...
  public GangsterService depotPV(PersonnageService p, int pv) throws PreconditionError,
      PostconditionError {
  ...
  public GangsterService retraitPV(PersonnageService p, int pv) throws PreconditionError,
      PostconditionError {
  ...
  public GangsterService depotArgent(PersonnageService p, int a) throws PreconditionError,
      PostconditionError {
    // argentRamasse@pre
  ...
  public GangsterService retraitArgent(PersonnageService p, int a) throws PreconditionError,
      PostconditionError {
    // argentRamasse@pre
    int tmpArgent = ArgentRamasse();
  ...
  public GangsterService ramasser(PersonnageService p, Objet o) throws PreconditionError,
      PostconditionError {

    // pre :estEquipe() == false
    if (estEquipe())
      throw new PreconditionError("Le gangster ne doit pas être équipé pour ramasser");
    ...
    // post : estEquipe() ==true
    if (!estEquipe())
      throw new PostconditionError("Le gangster doit être équipé d'un objet");
  ...
  public GangsterService jeter(PersonnageService p, Objet o) throws PostconditionError,
      PreconditionError {

    // pre :estEquipe() == true
    if (!estEquipe())
      throw new PreconditionError("Le perso ne doit pas être équipé pour ramasser");
    ...
    if (estEquipe())
      throw new PostconditionError("Le personnage ne doit pas être équipé d'un objet");
